...
export const routes: Routes = [
  ...
  { path: 'tasks/new', canActivate: [authGuard], loadComponent: () => import('./pages/task-dialog/task-dialog.component').then(m => m.TaskDialogComponent) },
  { path: 'tasks/:id/edit', canActivate: [authGuard], loadComponent: () => import('./pages/task-dialog/task-dialog.component').then(m => m.TaskDialogComponent) },
